...
public class skill7{
	...
	public skill7(Player player, Block block, SeichiSystemPlugin main, Boolean r) {
		int x = (int) block.x;
		int y = (int) block.y;
		int z = (int) block.z;
